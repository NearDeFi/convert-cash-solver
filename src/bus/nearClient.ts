...
export class NearClient {
    ...
    constructor() {
        ...
        this.signer = KeyPairSigner.fromSecretKey(privateKey as KeyPairString);
     ...
     */
    static toYoctoNear(amount: string): bigint {
     ...
     */
    static fromYoctoNear(amount: string | bigint): string {
